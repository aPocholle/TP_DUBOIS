...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins inverter_rtl_0/m_axis_aclk] [get_bd_pins inverter_rtl_0/s_axis_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  ...
  connect_bd_net -net inverter_rtl_0_m_axis_tuser [get_bd_pins inverter_rtl_0/m_axis_tuser] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tuser]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins inverter_rtl_0/m_axis_aresetn] [get_bd_pins inverter_rtl_0/s_axis_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/aresetn]
  ...
  connect_bd_net -net sw1_1 [get_bd_ports sw1] [get_bd_pins inverter_rtl_0/VidOrig_nVideoInv]
  ...
  connect_bd_net -net v_vid_in_axi4s_0_m_axis_video_tuser [get_bd_pins inverter_rtl_0/s_axis_tuser] [get_bd_pins v_vid_in_axi4s_0/m_axis_video_tuser]
