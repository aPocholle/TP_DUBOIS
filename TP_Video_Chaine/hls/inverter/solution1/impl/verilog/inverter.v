...
(* CORE_GENERATION_INFO="inverter,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.248000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2,HLS_SYN_LUT=49,HLS_VERSION=2019_2}" *)
...
always @ (*) begin
    if ((~((m_axis_video_TREADY_int == 1'b0) | (s_axis_video_TVALID_int == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign m_axis_video_TDATA_int = ((VidOrig_nVideoInv_V[0:0] === 1'b1) ? xor_ln214_fu_141_p2 : s_axis_video_TDATA_int);

assign m_axis_video_TVALID = regslice_both_m_axis_video_V_data_V_U_vld_out;

assign xor_ln214_fu_141_p2 = (s_axis_video_TDATA_int ^ 8'd255);
