...
architecture behav of inverter is 
    ...
    "inverter,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.248000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2,HLS_SYN_LUT=49,HLS_VERSION=2019_2}";
    ...
    signal xor_ln214_fu_141_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, regslice_both_m_axis_video_V_data_V_U_apdone_blk, s_axis_video_TVALID_int, m_axis_video_TREADY_int)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((m_axis_video_TREADY_int = ap_const_logic_0) or (s_axis_video_TVALID_int = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    m_axis_video_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state1, ap_CS_fsm_state2, m_axis_video_TREADY_int)
    begin
    ...
    m_axis_video_TDATA_int <= 
        xor_ln214_fu_141_p2 when (VidOrig_nVideoInv_V(0) = '1') else 
        s_axis_video_TDATA_int;
    m_axis_video_TVALID <= regslice_both_m_axis_video_V_data_V_U_vld_out;

    m_axis_video_TVALID_int_assign_proc : process(ap_CS_fsm_state1, s_axis_video_TVALID_int, m_axis_video_TREADY_int)
    begin
        if ((not(((m_axis_video_TREADY_int = ap_const_logic_0) or (s_axis_video_TVALID_int = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    s_axis_video_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state1, s_axis_video_TVALID_int)
    begin
    ...
    s_axis_video_TREADY_int_assign_proc : process(ap_CS_fsm_state1, s_axis_video_TVALID_int, m_axis_video_TREADY_int)
    begin
        if ((not(((m_axis_video_TREADY_int = ap_const_logic_0) or (s_axis_video_TVALID_int = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    xor_ln214_fu_141_p2 <= (s_axis_video_TDATA_int xor ap_const_lv8_FF);
end behav;
