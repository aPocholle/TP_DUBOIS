...
HD_PWD='C:/Users/Alexy/Documents/Dubois/TP_DUBOIS/TP_Video_Chaine/TP_Video_Chaine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_source_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_source_wrapper.tcl -notrace
