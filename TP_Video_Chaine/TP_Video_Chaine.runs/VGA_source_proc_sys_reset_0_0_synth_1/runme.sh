...
HD_PWD='C:/Users/ap576391/Documents/Dubois/TP1/TP_Video chain/TP_Video chain.runs/VGA_source_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_source_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_source_proc_sys_reset_0_0.tcl
