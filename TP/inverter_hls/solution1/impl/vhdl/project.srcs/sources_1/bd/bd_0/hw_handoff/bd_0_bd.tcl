...
proc create_root_design { parentCell } {
  ...
  set s_axis_video [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 s_axis_video ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {100000000.0} \
   CONFIG.HAS_TKEEP {1} \
   CONFIG.HAS_TLAST {1} \
  ...
  # Create ports
  set VidOrig_nVideoInv_V [ create_bd_port -dir I -from 0 -to 0 -type data VidOrig_nVideoInv_V ]
  set ap_clk [ create_bd_port -dir I -type clk -freq_hz 100000000.0 ap_clk ]
  set ap_rst_n [ create_bd_port -dir I -type rst ap_rst_n ]

  # Create instance: hls_inst, and set properties
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:inverter_hls:1.0 hls_inst ]

  # Create interface connections
  connect_bd_intf_net -intf_net ap_ctrl_0_1 [get_bd_intf_ports ap_ctrl] [get_bd_intf_pins hls_inst/ap_ctrl]
  connect_bd_intf_net -intf_net hls_inst_m_axis_video [get_bd_intf_ports m_axis_video] [get_bd_intf_pins hls_inst/m_axis_video]
  connect_bd_intf_net -intf_net s_axis_video_0_1 [get_bd_intf_ports s_axis_video] [get_bd_intf_pins hls_inst/s_axis_video]

  # Create port connections
  connect_bd_net -net VidOrig_nVideoInv_V_0_1 [get_bd_ports VidOrig_nVideoInv_V] [get_bd_pins hls_inst/VidOrig_nVideoInv_V]
