...
(* CORE_GENERATION_INFO="inverter_hls,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7vx485t-ffg1157-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.596000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2,HLS_SYN_LUT=54,HLS_VERSION=2019_2}" *)
...
reg    ap_block_state1;
wire   [0:0] icmp_ln761_fu_139_p2;
wire   [7:0] zext_ln295_fu_145_p1;
...
assign icmp_ln761_fu_139_p2 = ((s_axis_video_TDATA_int == 8'd0) ? 1'b1 : 1'b0);

assign m_axis_video_TDATA_int = ((VidOrig_nVideoInv_V[0:0] === 1'b1) ? zext_ln295_fu_145_p1 : s_axis_video_TDATA_int);

assign m_axis_video_TVALID = regslice_both_m_axis_video_V_data_V_U_vld_out;

assign zext_ln295_fu_145_p1 = icmp_ln761_fu_139_p2;

endmodule //inverter_hls
