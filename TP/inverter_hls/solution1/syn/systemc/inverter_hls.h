...
#ifndef _inverter_hls_HH_
#define _inverter_hls_HH_
...
struct inverter_hls : public sc_module {
    ...
    // Module declarations
    inverter_hls(sc_module_name name);
    SC_HAS_PROCESS(inverter_hls);
    ...
    sc_signal< sc_lv<1> > icmp_ln761_fu_139_p2;
    sc_signal< sc_lv<8> > zext_ln295_fu_145_p1;
    ...
    void thread_icmp_ln761_fu_139_p2();
    ...
    void thread_zext_ln295_fu_145_p1();
