...
architecture behav of inverter is 
    ...
    "inverter_inverter,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.248000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2,HLS_SYN_LUT=52,HLS_VERSION=2023_1}";
    ...
    signal tmp_data_1_fu_149_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal s_axis_video_TDATA_int_regslice : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal s_axis_video_TKEEP_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal s_axis_video_TSTRB_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal m_axis_video_TDATA_int_regslice : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component inverter_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    regslice_both_s_axis_video_V_data_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_keep_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_strb_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_user_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_last_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_id_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_dest_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_data_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_keep_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => s_axis_video_TKEEP_int_regslice,
        vld_in => m_axis_video_TVALID_int_regslice,
    ...
    regslice_both_m_axis_video_V_strb_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => s_axis_video_TSTRB_int_regslice,
        vld_in => m_axis_video_TVALID_int_regslice,
    ...
    regslice_both_m_axis_video_V_user_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_last_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_id_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => s_axis_video_TID_int_regslice,
        vld_in => m_axis_video_TVALID_int_regslice,
    ...
    regslice_both_m_axis_video_V_dest_V_U : component inverter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => s_axis_video_TDEST_int_regslice,
        vld_in => m_axis_video_TVALID_int_regslice,
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, regslice_both_m_axis_video_V_data_V_U_apdone_blk, s_axis_video_TVALID_int_regslice, m_axis_video_TREADY_int_regslice)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_start = ap_const_logic_0) or (m_axis_video_TREADY_int_regslice = ap_const_logic_0) or (s_axis_video_TVALID_int_regslice = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state1;
                end if;
            when ap_ST_fsm_state2 => 
                if ((not(((m_axis_video_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    ap_ST_fsm_state1_blk_assign_proc : process(ap_start, s_axis_video_TVALID_int_regslice, m_axis_video_TREADY_int_regslice)
    begin
        if (((ap_start = ap_const_logic_0) or (m_axis_video_TREADY_int_regslice = ap_const_logic_0) or (s_axis_video_TVALID_int_regslice = ap_const_logic_0))) then 
    ...
    ap_ST_fsm_state2_blk_assign_proc : process(regslice_both_m_axis_video_V_data_V_U_apdone_blk, m_axis_video_TREADY_int_regslice)
    begin
        if (((m_axis_video_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_1))) then 
    ...
    ap_block_state1_assign_proc : process(ap_start, s_axis_video_TVALID_int_regslice, m_axis_video_TREADY_int_regslice)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (m_axis_video_TREADY_int_regslice = ap_const_logic_0) or (s_axis_video_TVALID_int_regslice = ap_const_logic_0));
    end process;


    ap_block_state2_assign_proc : process(regslice_both_m_axis_video_V_data_V_U_apdone_blk, m_axis_video_TREADY_int_regslice)
    begin
                ap_block_state2 <= ((m_axis_video_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_1));
    end process;


    ap_done_assign_proc : process(ap_CS_fsm_state2, regslice_both_m_axis_video_V_data_V_U_apdone_blk, m_axis_video_TREADY_int_regslice)
    begin
        if ((not(((m_axis_video_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, regslice_both_m_axis_video_V_data_V_U_apdone_blk, m_axis_video_TREADY_int_regslice)
    begin
        if ((not(((m_axis_video_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    m_axis_video_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, m_axis_video_TREADY_int_regslice)
    begin
    ...
    m_axis_video_TDATA_int_regslice <= 
        tmp_data_1_fu_149_p2 when (VidOrig_nVideoInv(0) = '1') else 
        s_axis_video_TDATA_int_regslice;
    m_axis_video_TVALID <= regslice_both_m_axis_video_V_data_V_U_vld_out;

    m_axis_video_TVALID_int_regslice_assign_proc : process(ap_start, ap_CS_fsm_state1, s_axis_video_TVALID_int_regslice, m_axis_video_TREADY_int_regslice)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (m_axis_video_TREADY_int_regslice = ap_const_logic_0) or (s_axis_video_TVALID_int_regslice = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    s_axis_video_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_state1, s_axis_video_TVALID_int_regslice)
    begin
    ...
    s_axis_video_TREADY_int_regslice_assign_proc : process(ap_start, ap_CS_fsm_state1, s_axis_video_TVALID_int_regslice, m_axis_video_TREADY_int_regslice)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (m_axis_video_TREADY_int_regslice = ap_const_logic_0) or (s_axis_video_TVALID_int_regslice = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_1_fu_149_p2 <= (s_axis_video_TDATA_int_regslice xor ap_const_lv8_FF);
end behav;
